...
"""Utility to progressively remove numbers from a solved Sudoku.

After each removal the puzzle is solved from scratch and the number of
backtracking steps required is displayed.  This gives a rough indication of
how the difficulty increases as more cells are emptied.
"""
